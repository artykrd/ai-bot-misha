# Crisp Upscale API Documentation

> Generate content using the Crisp Upscale model

## Overview

This document describes how to use the Crisp Upscale model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `recraft/crisp-upscale` |
...
|----------|-------|-------------|
| **Format** | `recraft/crisp-upscale` | The exact model identifier for this API |
...
- **Type**: `string`
- **Required**: Yes
- **Description**: Please provide the URL of the uploaded file,Image to upscale
- **Max File Size**: 10MB
- **Accepted File Types**: image/jpeg, image/png, image/webp
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1757169577325ijj8vwvt.jpg"`
...
```json
{
  ...
  "data": {
    ...
    "model": "recraft/crisp-upscale",
    "state": "waiting",
    "param": "{\"model\":\"recraft/crisp-upscale\",\"input\":{\"image\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/1757169577325ijj8vwvt.jpg\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/175716958581508ml45fr.jpg\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
