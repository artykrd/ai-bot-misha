...
INSERT INTO subscription_plans (plan_id, name, description, tokens_amount, duration_days, price, button_text, sort_order) VALUES
    ('tariff_1', '7 дней', 'Базовый тариф на неделю', 150000, 7, 88.00, '7 дней — 150,000 токенов — 88 руб.', 1),
    ('tariff_2', '14 дней', 'Стандартный тариф на 2 недели', 250000, 14, 176.00, '14 дней — 250,000 токенов — 176 руб.', 2),
    ('tariff_3', '21 день', 'Расширенный тариф на 3 недели', 500000, 21, 260.00, '21 день — 500,000 токенов — 260 руб.', 3),
    ('tariff_6', '30 дней (1M)', 'Месячный тариф с 1M токенов', 1000000, 30, 537.00, '30 дней — 1,000,000 токенов — 537 руб.', 4),
    ('tariff_21', '30 дней (5M)', 'Премиум тариф с 5M токенов', 5000000, 30, 2511.00, '30 дней — 5,000,000 токенов — 2511 руб.', 5),
    ('tariff_22', 'Безлимит 1 день', 'Безлимитный доступ на 1 день', 999999999, 1, 649.00, '🔥 Безлимит на 1 день', 6)
